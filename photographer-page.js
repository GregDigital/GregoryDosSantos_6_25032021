            ...
            return `
                  ...
                  <article class="pp_media">
                    ...
                    <div class="pp_media_infos">
                      ...
                      <span class="media_infos-like" id="">${usermedia.likes} <div class="fas fa-heart test" role="button"></div></span>
                    </div>
                  </article>
...
fetch("json/profil.json")
    ...
    heart = document.querySelectorAll('.test')

    heart.forEach((btn) => btn.addEventListener('click', test));
